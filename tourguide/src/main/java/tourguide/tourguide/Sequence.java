    ...
    protected void setParentTourGuide(TourGuide parentTourGuide) {
        ...
        if (mContinueMethod == ContinueMethod.Overlay) {
            for (final TourGuide tourGuide : mTourGuideArray) {
                tourGuide.mOverlay.setOnClickListener(new View.OnClickListener() {
                    @Override
    ...
    public static class SequenceBuilder {
        ...
        private void checkOverlayListener(ContinueMethod continueMethod) {
            if (continueMethod == ContinueMethod.OverlayListener) {
                boolean pass = true;
                if (mDefaultOverlay != null && mDefaultOverlay.getOnClickListener() != null) {
                    pass = true;
                    ...
                    for (TourGuide tourGuide : mTourGuideArray) {
                        ...
                        if (tourGuide.mOverlay != null && tourGuide.mOverlay.getOnClickListener() == null) {
                            tourGuide.mOverlay.setOnClickListener(mDefaultOverlay.getOnClickListener());
                        }
                    }
